...
' Public Properties:
' ------------------
' - FileFullName r/w The full name of the trace-log-file, defaults to
'                    ThisWorkbook's named "ExecTrace.log".
' - KeepDays     w   Specifies the number of days a trace-log-file is kept
